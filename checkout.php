                ...
                <div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?php echo 'Kshs '; ?><?php echo $arr_cart_p_current_price[$i]; ?></td>
                            ...
                            <td class="text-right">
                                ...
                                ?>
                                <?php echo 'Kshs '; ?><?php echo $row_total_price; ?>
                            </td>
                        </tr>
                        <?php endfor; ?>           
                        <tr>
                            <th colspan="7" class="total-text"><?php echo LANG_VALUE_81; ?></th>
                            <th class="total-amount"><?php echo 'Kshs '; ?><?php echo $table_total_price; ?></th>
                        </tr>
                        <?php
                        ...
                        <tr>
                            ...
                            <td class="total-amount"><?php echo 'Kshs '; ?><?php echo $shipping_cost; ?></td>
                        </tr>
                        <tr>
                            ...
                            <th class="total-amount">
                                ...
                                ?>
                                <?php echo 'Kshs '; ?><?php echo $final_total; ?>
                            </th>
                        </tr>
                    </table> 
                </div>
